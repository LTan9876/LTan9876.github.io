...
export default class About extends React.Component {
  render() {
    return (
      <div>
        <img src = 'https://media-exp1.licdn.com/dms/image/C4D03AQHJe5fSwQWCug/profile-displayphoto-shrink_200_200/0?e=1591833600&v=beta&t=LrjDncmbI4U-3aCwsEghjsgopDALj6mk0vvqWj-C7a4' alt = 'profilepic' class = 'profile'></img>
      <p>
      ...
      <p>
        In my spare time I like to read, and listen to podcasts.  I love seeing the process of world building in a story.  I'm currently reading IQ84 by Haruku Murakami, and listening to The Left Right Game.
      </p>
      </div>
    )
  }
